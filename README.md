# fastapi-demo-app Application (FastAPI)
...
* Source: [fastapi-demo-app (this repo)](https://github.com/essesseff-demo-account/fastapi-demo-app)
* Helm Config DEV: [fastapi-demo-app-config-dev](https://github.com/essesseff-demo-account/fastapi-demo-app-config-dev)
* Helm Config QA: [fastapi-demo-app-config-qa](https://github.com/essesseff-demo-account/fastapi-demo-app-config-qa)
* Helm Config STAGING: [fastapi-demo-app-config-staging](https://github.com/essesseff-demo-account/fastapi-demo-app-config-staging)
* Helm Config PROD: [fastapi-demo-app-config-prod](https://github.com/essesseff-demo-account/fastapi-demo-app-config-prod)
* Argo CD Config DEV: [fastapi-demo-app-argocd-dev](https://github.com/essesseff-demo-account/fastapi-demo-app-argocd-dev)
* Argo CD Config QA: [fastapi-demo-app-argocd-qa](https://github.com/essesseff-demo-account/fastapi-demo-app-argocd-qa)
* Argo CD Config STAGING: [fastapi-demo-app-argocd-staging](https://github.com/essesseff-demo-account/fastapi-demo-app-argocd-staging)
* Argo CD Config PROD: [fastapi-demo-app-argocd-prod](https://github.com/essesseff-demo-account/fastapi-demo-app-argocd-prod)
...
* **K8s Namespace**: unless otherwise specified, this template assumes, by default, a mapping of GitHub organization ~ K8s namespace i.e. string replace `essesseff-demo-account` with your K8s namespace (or if an [essesseff](https://essesseff.com) subscriber, simply create an app from this template to have that standard convention enforced automatically)
...
```bash
# Build container
docker build -t fastapi-demo-app-fastapi:local .

# Run container
docker run -p 8080:8080 fastapi-demo-app-fastapi:local
```
